...
housing_median_age = st.number_input("Idade de Imóvel", value = 10)
...
ocean_proximity = st.selectbox("Proximidade de oceano", df["ocean_proximity"].unique())
...
if botao_previsao:
    ...
    st.write(f"Preço previsao: US$ {preco[0][0]:.2f}")